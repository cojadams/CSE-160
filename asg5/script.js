...
function main() {
	...
	/**
	 * @param {GameObject} gameObject    – the empty GameObject to attach under
	 * @param {{gltf}} modelInfo         – one of your models, e.g. models.building
	 * @param {number} x                 – world‐space X position
	 * @param {number} z                 – world‐space Z position
	 * @param {number} [scale=1]         – uniform scale factor (optional)
	 * @param {number} [yOffset=0]       – how much Y to lift it above ground (optional)
	 * @param {number} [rotY=0]          – rotation around Y‐axis in radians (optional)
	 */
	...
	function init() {
		...
		// — “Generic Building” at ( 5,  5)
		// {
		// 	const go = gameObjectManager.createGameObject(scene, 'genericBuilding');
		// 	go.addComponent(
		// 	Building,
		// 	models.building, 
		// 	5,
		...
		// — Hotel at (-7, 12)
		// {
		// 	const go = gameObjectManager.createGameObject(scene, 'hotel');
		// 	go.addComponent(
		// 	Building,
		// 	models.hotel,   // models.hotel from your loader
		// 	/* x= */ -7,
		// 	/* z= */ 12,
		// 	/* scale= */ uniformScale * 0.8, // slightly smaller
		// 	/* yOffset= */ groundY,
		// 	/* rotY= */ -Math.PI / 2       // face “south”
		// 	);
		// }
